      ...
      <div className="embla__viewport" ref={emblaRef}>
        <div className="embla__container gap-[10%]">
          {slides.map((index) => (
            <div
              key={index}
              className="embla__slide bg-[#F5F5F580] dark:bg-inherit flex items-center justify-between"
            >
              <div className="py-16 px-10 w-4/5">
                <p className="text-[14px] text-[#3D3D3D]">
                  Welcome to GreenShop
                </p>
                <h1 className="text-[70px] font-extrabold leading-[70px] my-1.5">
                  Let’s Make a <br />
                  Better <span className="text-[#46A358]">Planet</span>
                </h1>
                <p className="text-[14px] text-[#727272] mb-10 w-5/6">
